...
| M7_blend | Blend-4 | `{"w": [0.9, 0.0, 0.0, 0.1], "members": ["Ridge-10", "Enet", "M4", "M6"]}` | 0.1114 ± 0.00787 | ensemble 4 mô hình, trọng số tune trên OOF | LB lần 1: 0.12581 (tốt nhất) | bản nộp Kaggle lần 1 |
...
| M7b_blend2 | Blend2 | `{"w_old": 1.0, "w_new": 0.0}` | 0.1114 ± 0.00787 | M7 cũ + Ridge đặc trưng mới (tỉ lệ 100-0) | LB lần 2: 0.12581 | bản nộp Kaggle lần 2 (giống hệt lần 1) |
...
| M7c_blend3 | Blend3 | `{"w_old": 0.9, "w_new": 0.1}` | 0.11128 ± 0.00845 | M7 cũ + M4b đặc trưng mới | LB lần 3: 0.12805 | bản nộp Kaggle lần 3 |
...
| M7d_blend4 | Blend4 | `{"w_cur": 0.7, "w_new": 0.3}` | 0.11103 ± 0.00848 | M7 hiện tại + Ridge phạt mạnh | LB lần 4: 0.12679 | bản nộp Kaggle lần 4 |
| M4seed_s0 | MLP1-seed | `{"h": 64, "seed": 1043}` | 0.1247 ± 0.00982 | seed 1043 | gộp ensemble |
| M4seed_s1 | MLP1-seed | `{"h": 64, "seed": 1044}` | 0.12332 ± 0.01192 | seed 1044 | gộp ensemble |
| M4seed_s2 | MLP1-seed | `{"h": 64, "seed": 1045}` | 0.12476 ± 0.0108 | seed 1045 | gộp ensemble |
| M4seed_mean | MLP1-seed-mean | `{"h": 64, "seeds": 3}` | 0.12291 ± 0.01143 | trung bình 3 seed | giữ để trộn (nhưng M7e không cần) |
| M7e_blend5 | Blend5-thử | `{"w_cur": 1.0, "w_new": 0.0}` | 0.11103 ± 0.0 | M7d + seed-ensemble M4 (tỉ lệ 100-0) | LB lần 5: 0.12679 | bản nộp Kaggle lần 5 (giống hệt lần 4) |
